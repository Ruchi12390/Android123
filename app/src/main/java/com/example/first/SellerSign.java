        ...
        signUpButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (name.isEmpty() || email.isEmpty() || phone.isEmpty() || address.isEmpty() ||
                    ...
                    Toast.makeText(SellerSign.this, "Please fill all required fields", Toast.LENGTH_SHORT).show();
                } else {
                    ...
                    DatabaseHelper dbHelper = new DatabaseHelper(SellerSign.this);
                    dbHelper.addBuyer(buyer);

                    Toast.makeText(SellerSign.this, "Seller registered successfully!", Toast.LENGTH_SHORT).show();
